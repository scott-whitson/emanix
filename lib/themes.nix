...
rec {
  ...
  #
  # Custom properties use an --emanix- prefix, not --ctp- (Catppuccin): this
  ...
  # --emanix- matches this repo's own naming vocabulary instead of any one
  # palette's.
  #
  ...
  firefoxChrome = palette: ''
    /* Generated by dotfiles/lib/themes.nix — ${palette.variant} variant */
    :root {
      --emanix-base: ${palette.colors.base};
      --emanix-mantle: ${palette.colors.mantle};
      --emanix-crust: ${palette.colors.crust};
      --emanix-text: ${palette.colors.text};
      --emanix-subtext0: ${palette.colors.subtext0};
      --emanix-surface0: ${palette.colors.surface0};
      --emanix-surface1: ${palette.colors.surface1};
      --emanix-accent: ${palette.colors.blue};
    }

    #navigator-toolbox {
      background-color: var(--emanix-mantle) !important;
      border-bottom: 1px solid var(--emanix-surface0) !important;
    }

    #TabsToolbar, #nav-bar, #PersonalToolbar {
      background-color: var(--emanix-mantle) !important;
      color: var(--emanix-text) !important;
    }

    .tabbrowser-tab .tab-content {
      color: var(--emanix-subtext0) !important;
    }
    ...
    .tabbrowser-tab[selected] .tab-background {
      background-color: var(--emanix-base) !important;
      border-top: 2px solid var(--emanix-accent) !important;
    }

    #urlbar, #searchbar {
      background-color: var(--emanix-surface0) !important;
      color: var(--emanix-text) !important;
      border: 1px solid var(--emanix-surface1) !important;
    }

    #urlbar[focused="true"] {
      border-color: var(--emanix-accent) !important;
    }
    ...
    lib.concatStringsSep "\n"
      (
        [
          ...
          "# GENERATED by emanix lib/themes.nix — do not hand-edit."
  ...
  btop = palette:
    let
      ...
      marker = "@@EMANIX-TEMPLATE-HEADER-END@@\n";
      parts = lib.splitString marker raw;
      body =
        if builtins.length parts == 2
        then builtins.elemAt parts 1
        else throw "btop.theme.in: expected exactly one @@EMANIX-TEMPLATE-HEADER-END@@ marker";
    in
    "# GENERATED by emanix lib/themes.nix — do not hand-edit.\n"
