;;; eminix-openrouter-test.el --- ERT tests -*- lexical-binding: t; -*-
(require 'ert)
(require 'eminix-openrouter)

(ert-deftest eminix-openrouter-summarize ()
  ...
  (let* ((now (encode-time (iso8601-parse "2026-07-07T12:00:00Z")))
         ...
         (out (eminix-openrouter--summarize activity key-data now)))
...
(ert-deftest eminix-openrouter-summarize-no-double-count-today ()
